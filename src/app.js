  ...
  if(!turnBuilt){
    ...
    host.innerHTML =
      `<div class="ctl"><div class="ctl-top">
       ...
       <div class="ctl"><div class="ctl-top">
         <label for="ldk">How much a busy department ties up the provider</label>
       ...
       <div class="hint">When the rest of the department is full, the provider is <b>less
         available to this lane</b> &mdash; and that, not slower care, is what crowding does here.
         Split the wait apart and the whole effect sits in the time to be <i>seen</i> (+15% per
         extra patient in the building); the time from the doctor arriving to the patient leaving
         moves <b>+0.5%, which is nothing</b>. So this dial lengthens the provider's own minutes,
         by about <b>3.4% per extra patient</b>, and leaves care alone. <b>It does nothing with no
         provider set below.</b> 100% is the effect as measured; 0 turns it off. Whether crowding
         <i>causes</i> it is not established &mdash; a slow shift produces both &mdash; which is
         why it is a dial.</div>`;
