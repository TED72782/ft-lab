    ...
    host.innerHTML =
      `<div class="ctl"><div class="ctl-top">
       ...
       <div class="hint">Holds are measurably longer when the department is full &mdash; about
         ...
         same comparison and only the department's survives, so a fuller lane does not slow itself
         down. <b>100% is the effect as measured; 0 turns it off.</b> Whether crowding
         <i>causes</i> the stretch is not established &mdash; a slow shift produces both &mdash;
         which is why it is a dial.</div>`;
